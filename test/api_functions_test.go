...
func Test_openapi_chaos_client_FunctionsAPIService(t *testing.T) {
	...
	t.Run("Test FunctionsAPIService ProjectsFunctionsCreate", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var projectId string

		resp, httpRes, err := apiClient.FunctionsAPI.ProjectsFunctionsCreate(context.Background(), projectId).Execute()
