...
type ProjectsAPIProjectsQuotasGetRequest struct {
	ctx context.Context
	ApiService *ProjectsAPIService
	projectId string
...
func (r ProjectsAPIProjectsQuotasGetRequest) Execute() ([]Quota, *http.Response, error) {
...
Get a specific quota for a project
 ...
 @return ProjectsAPIProjectsQuotasGetRequest
*/
func (a *ProjectsAPIService) ProjectsQuotasGet(ctx context.Context, projectId string, quotaEntityQuota string) ProjectsAPIProjectsQuotasGetRequest {
	return ProjectsAPIProjectsQuotasGetRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return []Quota
func (a *ProjectsAPIService) ProjectsQuotasGetExecute(r ProjectsAPIProjectsQuotasGetRequest) ([]Quota, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsAPIService.ProjectsQuotasGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ProjectsAPIProjectsQuotasListRequest struct {
	ctx context.Context
	ApiService *ProjectsAPIService
	projectId string
}

func (r ProjectsAPIProjectsQuotasListRequest) Execute() ([]Quota, *http.Response, error) {
...
Get the quotas for a project
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId Project ID reference
 @return ProjectsAPIProjectsQuotasListRequest
*/
func (a *ProjectsAPIService) ProjectsQuotasList(ctx context.Context, projectId string) ProjectsAPIProjectsQuotasListRequest {
	return ProjectsAPIProjectsQuotasListRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return []Quota
func (a *ProjectsAPIService) ProjectsQuotasListExecute(r ProjectsAPIProjectsQuotasListRequest) ([]Quota, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsAPIService.ProjectsQuotasList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
