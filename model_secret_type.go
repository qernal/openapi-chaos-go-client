...
// SecretType Secrets types: registry, certificate, environment, dek
type SecretType string

// List of SecretType
const (
	SECRETTYPE_REGISTRY SecretType = "registry"
	SECRETTYPE_CERTIFICATE SecretType = "certificate"
	SECRETTYPE_ENVIRONMENT SecretType = "environment"
	SECRETTYPE_DEK SecretType = "dek"
)
